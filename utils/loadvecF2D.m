function gg = loadvecF2D(f1,f2,tau_grid,h,NGpoints,norm)
% FF = LOADVECF2D(F,TAU,HINT,NGPOINTS) computes the load vector FF 
...
for i_deco = 1:length(f1)
    ...
    gg = gg + kron(gg_1{i_deco},gg_2{i_deco});
end
switch norm
    case 'H1'
