...
% "/data/Data_Figure11_article". To repeat the computation, run the file
% "Compute_Figure11". This will produce a new MAT file
% "/data/Data_Figure11" that has to be loaded in place of
% "/data/Data_Figure11_article".

% Simone Brugiapaglia, 2018 (simone.brugiapaglia@sfu.ca)
clear all
close all

load data/Figure11_article.mat
%% Uncomment the following line to use new data
% load data/Figure10_new
